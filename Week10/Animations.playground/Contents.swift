...
extension UIView {
  ...
  // TODO: Fill in this implementation
    group.enter()
    print("JD: - just entered group...")
    animate(withDuration: duration, animations: animations) { (done) in
    completion?(done)
      print("JD: - will leave group now.")
      group.leave()
    }
  }
}
...
UIView.animate(withDuration: 1, animations: {
  print("JD: - start anim with 1 duration...")
...
UIView.animate(withDuration: 4, animations: {
  print("JD: - start anim with 4 duration...")
